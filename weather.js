$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>The weather report today is "+data.currently.summary+", tommorrow the weather will be "+data.daily.data[1].summary+", the date after that it will be "+data.daily.data[2].summary+", and the day after that will be "+data.daily.data[3].summary+"</p>";
